...
function SecuritySharing() {
  ...
  // Page-level wrapper for clear surface/background distinction
  return (
    <div
      style={{
        width: "100vw",
    ...
    >
      ...
      <div
        style={{
          maxWidth: 400,
          margin: "54px auto",
          background: "var(--surface)", // always palette surface
          borderRadius: 36,
          ...
          minHeight: 440,
          position: "relative",
          width: "100%", // allow center + responsiveness
        }}
      >
        <div
          style={{
        ...
        {!unlocked ? (
          <form
            ...
            style={{
              ...
              gap: 13,
              padding: "0 2px",
              background: "var(--surface)", // PIN area always surface
              borderRadius: 16,
            }}
          >
            <label
            ...
            <input
              ...
              style={{
                ...
                padding: "8px 8px",
                outline: "none",
                // PIN input field must strongly contrast card: use var(--surface-alt) but never direct color
          ...
          <div
            style={{
              margin: "35px 0 0 0",
              animation: pinSuccessAnim
                ? "unlock-pop 0.87s cubic-bezier(.29,1.8,.29,1.05) both"
                : "none",
            }}
          >
            <div
        ...
        >
          ...
          <button
            ...
            tabIndex={0}
          >
            Generate Invite Link&nbsp; <span aria-label="link" role="img">
              🔗
            </span>
          </button>
          {showInvite && (
            <div
              style={{
                marginTop: 17,
                background: "var(--surface)", // invitation code background must be surface, not background!
                color: "var(--text-dark)",
                padding: "16px 8px 13px 8px",
                borderRadius: 12,
                boxShadow:
                  "0 3px 15px 0 var(--accent-gold)13, 0 1.5px 6px var(--accent-1)25",
                animation: codeAnim
                  ? "invite-pop 1s cubic-bezier(.27,1.0,.48,0.88) both"
                  : "none",
              }}
            >
              <div
        ...
        >
          This is a demo! In the real PiggyPal, your PIN would keep your money safe and invite links would let trusted people add to your goal!
          <br />
          Try unlocking and sharing now.
        </div>
      </div>
    </div>
  );
